...
*/
  ...
  function gallery_meta_callback($post) {
    ...
    <table class="form-table">
      <tr><td>
        <a class="gallery-add button" href="#" data-uploader-title="Add image(s) to gallery" data-uploader-button-text="Add image(s)">Add imagem</a>
        ...
        <?php if ($ids) : foreach ($ids as $key => $value) : $image = wp_get_attachment_image_src($value); ?>
          ...
          <li>
            ...
            <a class="change-image button button-small" href="#" data-uploader-title="Change image" data-uploader-button-text="Change image">Alterar imagens</a><br>
            <small><a class="remove-image" href="#">Remover imagens</a></small>
          </li>
